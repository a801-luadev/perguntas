local texts = {
	...
	es = {
		title = "Preguntas",
		displayAnswer = "La respuesta a la pregunta fue <B>%s</B>",
		...
		help = "<CEP>El minijuego consiste en un Chamán que hará preguntas para que otros jugadores las respondan. El primer jugador en acertar 5 preguntas gana el juego y se convierte en el próximo chamán.",
		helpAdmin = "<R>Comandos del administrador de la sala:\n- <B>!skip</B> - Elige a otro chamán para hacer las preguntas.\n- <B>!players</B> - Activa el sistema de prohibición del módulo. Si está activado, los jugadores podrán usar <B>!skip</B> para votar para saltarse al chamán actual.\n- <B>!next</B> <V>[nombre del jugador]</V> - Elige al siguiente chamán.\n- <B>!pw</B> <V>[contraseña]</V> - Establece una contraseña para la sala",
		helpSkip = "Escribe <B>!skip</B> para votar para saltar el turno del chamán actual",
		enterQuestion = "Escribe tu pregunta",
		skipFromShaman = "<R>%s ha saltado su turno",
		skipAttemptDisabled = "<R>El comando <B>!skip</B> está desactivado",
		skipAttemptDisabled = "<R>El comando <B>!skip</B> está desactivado",
		skipShaman = "Se ha saltado el turno de <R>%s",
		skipShaman = "Se ha saltado el turno de <R>%s",
		skipEnabled = "- <B>!skip</B> habilitado",
		skipDisabled = "- <B>!skip</B> deshabilitado",
		seeQuestion = "Su pregunta: %s",
		enterAnswer = "Escriba la respuesta a su pregunta",
		seeAnswer = "La respuesta para su pregunta: %s",
		win = "<VP>%s ¡tiene la respuesta correcta!"
	}
}
